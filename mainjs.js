...
app.controller("ctrlDienThoai", function ($scope, $rootScope) {
    ...
    $rootScope.sanphamArray = [].concat($scope.firstSlide, $scope.secondSlide, $scope.thirdSlide);
...
app.controller("ctrlLaptop", function ($scope, $rootScope) {
    ...
    $rootScope.sanphamArray = $rootScope.sanphamArray.concat($scope.firstSlide, $scope.secondSlide, $scope.thirdSlide);
})
